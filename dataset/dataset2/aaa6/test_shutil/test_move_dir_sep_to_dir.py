...
def test_move_dir_sep_to_dir():
    TestMove._check_move_dir(TestMove.src_dir + os.path.sep, TestMove.dst_dir, os.path.join(TestMove.dst_dir, os.path.basename(TestMove.src_dir)))
