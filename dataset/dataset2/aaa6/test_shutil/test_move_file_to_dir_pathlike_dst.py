...
def test_move_file_to_dir_pathlike_dst():
    dst = pathlib.Path(TestMove.dst_dir)
    TestMove._check_move_file(TestMove.src_file, dst, TestMove.dst_file)

TestMove = test_shutil.TestMove()
TestMove.setUp()
test_move_file_to_dir_pathlike_dst()
