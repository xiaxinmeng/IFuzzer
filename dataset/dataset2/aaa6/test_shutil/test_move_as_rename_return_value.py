...
def test_move_as_rename_return_value():
    rv = shutil.move(TestMove.src_file, os.path.join(TestMove.dst_dir, 'bar'))
    TestMove.assertEqual(rv, os.path.join(TestMove.dst_dir, 'bar'))
