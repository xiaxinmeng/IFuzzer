...
def test_move_file_symlink():
    ...
    shutil.move(dst, TestMove.dst_file)
    TestMove.assertTrue(os.path.islink(TestMove.dst_file))
    TestMove.assertTrue(os.path.samefile(TestMove.src_file, TestMove.dst_file))

TestMove = test_shutil.TestMove()
TestMove.setUp()
test_move_file_symlink()
