...
def test_move_file_to_dir_pathlike_src():
    src = pathlib.Path(TestMove.src_file)
    TestMove._check_move_file(src, TestMove.dst_dir, TestMove.dst_file)

TestMove = test_shutil.TestMove()
TestMove.setUp()
test_move_file_to_dir_pathlike_src()
