...
def test_move_return_value():
    rv = shutil.move(TestMove.src_file, TestMove.dst_dir)
    TestMove.assertEqual(rv, os.path.join(TestMove.dst_dir, os.path.basename(TestMove.src_file)))

TestMove = test_shutil.TestMove()
TestMove.setUp()
test_move_return_value()
