...
def test_setting_copyright():
    ImportSideEffectTests.assertTrue(hasattr(builtins, 'copyright'))
    ImportSideEffectTests.assertTrue(hasattr(builtins, 'credits'))
    ImportSideEffectTests.assertTrue(hasattr(builtins, 'license'))
