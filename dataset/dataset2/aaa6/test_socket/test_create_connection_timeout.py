...
def test_create_connection_timeout():
    with NetworkConnectionNoServer.mocked_socket_module():
        try:
            socket.create_connection((test_socket.HOST, 1234))
        except TimeoutError:
            pass
            ...
            NetworkConnectionNoServer.fail('TimeoutError not raised')
