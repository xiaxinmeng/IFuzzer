...
def test_send_unicode_with_SMTPUTF8_via_sendmail():
    ...
    SMTPUTF8SimTests.assertEqual(SMTPUTF8SimTests.serv.last_mailfrom, 'Jőhn')
    SMTPUTF8SimTests.assertEqual(SMTPUTF8SimTests.serv.last_rcpttos, ['Sálly'])
