...
def test_expat_locator_withinfo():
    ...
    parser.parse(test_sax.TEST_XMLFILE)
    ExpatReaderTest.assertEqual(parser.getSystemId(), test_sax.TEST_XMLFILE)
    ExpatReaderTest.assertEqual(parser.getPublicId(), None)
