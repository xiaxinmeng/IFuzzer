...
def test_init_new_overridden():
    e = test_exception_hierarchy.SubOSErrorCombinedInitFirst('some message', 'baz')
    ...
    e = test_exception_hierarchy.SubOSErrorCombinedNewFirst('some message', 'baz')
    ExplicitSubclassingTest.assertEqual(e.bar, 'baz')
    ExplicitSubclassingTest.assertEqual(e.baz, 'baz')
    ExplicitSubclassingTest.assertEqual(e.args, ('some message',))

ExplicitSubclassingTest = test_exception_hierarchy.ExplicitSubclassingTest()
test_init_new_overridden()
