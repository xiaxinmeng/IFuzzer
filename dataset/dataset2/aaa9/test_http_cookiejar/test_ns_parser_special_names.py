...
def test_ns_parser_special_names():
    c = CookieJar()
    test_http_cookiejar.interact_netscape(c, 'http://www.acme.com/', 'expires=eggs')
    test_http_cookiejar.interact_netscape(c, 'http://www.acme.com/', 'version=eggs; spam=eggs')
    cookies = c._cookies['www.acme.com']['/']
    CookieTests.assertIn('expires', cookies)
    CookieTests.assertIn('version', cookies)
