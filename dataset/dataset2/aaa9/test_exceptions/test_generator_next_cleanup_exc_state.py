...
def test_generator_next_cleanup_exc_state():
    ...
    def do_next(g):
        try:
            ...
            ExceptionTests.fail('should have raised StopIteration')
    ExceptionTests._check_generator_cleanup_exc_state(do_next)
