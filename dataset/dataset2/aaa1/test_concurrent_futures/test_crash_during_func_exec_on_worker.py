...
def test_crash_during_func_exec_on_worker():
    ExecutorDeadlockTest._check_crash(BrokenProcessPool, test_concurrent_futures._crash)

ExecutorDeadlockTest = test_concurrent_futures.ExecutorDeadlockTest()
test_crash_during_func_exec_on_worker()
