...
def test_max_workers_negative():
    for number in (0, -1):
        with ExecutorTest.assertRaisesRegex(ValueError, 'max_workers must be greater than 0'):
            ExecutorTest.executor_type(max_workers=number)
