...
def test_error_at_task_unpickle():
    ExecutorDeadlockTest._check_crash(BrokenProcessPool, id, test_concurrent_futures.ErrorAtUnpickle())

ExecutorDeadlockTest = test_concurrent_futures.ExecutorDeadlockTest()
test_error_at_task_unpickle()
