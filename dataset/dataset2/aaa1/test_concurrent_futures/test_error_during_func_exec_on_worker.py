...
def test_error_during_func_exec_on_worker():
    ExecutorDeadlockTest._check_crash(RuntimeError, test_concurrent_futures._raise_error, RuntimeError)

ExecutorDeadlockTest = test_concurrent_futures.ExecutorDeadlockTest()
test_error_during_func_exec_on_worker()
