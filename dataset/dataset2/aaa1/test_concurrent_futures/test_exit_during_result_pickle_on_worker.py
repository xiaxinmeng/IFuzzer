...
def test_exit_during_result_pickle_on_worker():
    ExecutorDeadlockTest._check_crash(SystemExit, test_concurrent_futures._return_instance, test_concurrent_futures.ExitAtPickle)

ExecutorDeadlockTest = test_concurrent_futures.ExecutorDeadlockTest()
test_exit_during_result_pickle_on_worker()
