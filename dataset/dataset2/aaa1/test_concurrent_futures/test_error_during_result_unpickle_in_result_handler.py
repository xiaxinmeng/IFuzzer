...
def test_error_during_result_unpickle_in_result_handler():
    ExecutorDeadlockTest._check_crash(BrokenProcessPool, test_concurrent_futures._return_instance, test_concurrent_futures.ErrorAtUnpickle, ignore_stderr=True)
