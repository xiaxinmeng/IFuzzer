...
def test_exit_during_func_exec_on_worker():
    ExecutorDeadlockTest._check_crash(SystemExit, test_concurrent_futures._exit)

ExecutorDeadlockTest = test_concurrent_futures.ExecutorDeadlockTest()
test_exit_during_func_exec_on_worker()
