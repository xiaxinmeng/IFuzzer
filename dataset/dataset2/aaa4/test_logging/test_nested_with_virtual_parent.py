...
def test_nested_with_virtual_parent():
    ...
    GRANDCHILD.debug(m())
    CHILD.debug(m())
    BuiltinLevelsTest.assert_log_lines([('INF.BADPARENT.UNDEF', 'CRITICAL', '1'), ('INF.BADPARENT.UNDEF', 'INFO', '2'), ('INF.BADPARENT', 'CRITICAL', '3'), ('INF.BADPARENT', 'INFO', '4')])

BuiltinLevelsTest = test_logging.BuiltinLevelsTest()
BuiltinLevelsTest.setUp()
test_nested_with_virtual_parent()
