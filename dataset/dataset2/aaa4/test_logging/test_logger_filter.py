...
def test_logger_filter():
    CustomLevelsAndFiltersTest.root_logger.setLevel(test_logging.VERBOSE)
    CustomLevelsAndFiltersTest.log_at_all_levels(CustomLevelsAndFiltersTest.root_logger)
    CustomLevelsAndFiltersTest.assert_log_lines([('Verbose', '5'), ('Sociable', '6'), ('Effusive', '7'), ('Terse', '8'), ('Taciturn', '9'), ('Silent', '10')])
