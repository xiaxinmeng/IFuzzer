...
def test_regression_22386():
    """See issue #22386 for more information."""
    BuiltinLevelsTest.assertEqual(logging.getLevelName('INFO'), logging.INFO)
    BuiltinLevelsTest.assertEqual(logging.getLevelName(logging.INFO), 'INFO')
