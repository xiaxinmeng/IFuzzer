...
def test_custom_formatter_class_with_validate3():
    ConfigDictTest.assertRaises(ValueError, ConfigDictTest.apply_config, ConfigDictTest.custom_formatter_class_validate3)

ConfigDictTest = test_logging.ConfigDictTest()
test_custom_formatter_class_with_validate3()
