...
def test_custom_formatter_class_with_validate2_with_wrong_fmt():
    config = ConfigDictTest.custom_formatter_class_validate.copy()
    ...
    ConfigDictTest.assertIsInstance(handler.formatter, test_logging.ExceptionFormatter)

ConfigDictTest = test_logging.ConfigDictTest()
test_custom_formatter_class_with_validate2_with_wrong_fmt()
