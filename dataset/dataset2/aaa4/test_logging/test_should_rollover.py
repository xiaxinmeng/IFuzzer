...
def test_should_rollover():
    rh = logging.handlers.RotatingFileHandler(RotatingFileHandlerTest.fn, maxBytes=1)
    RotatingFileHandlerTest.assertTrue(rh.shouldRollover(RotatingFileHandlerTest.next_rec()))
    rh.close()
