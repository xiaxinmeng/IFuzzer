...
def test_unicode_docstring():
    ...
    ModuleTests.assertEqual(foo.__doc__, 'foodocሴ')
    ModuleTests.assertEqual(foo.__dict__, {'__name__': 'foo', '__doc__': 'foodocሴ', '__loader__': None, '__package__': None, '__spec__': None})
