...
def test_non_text_encoding_codecs_are_rejected():
    r = TextIOWrapperTest.BytesIO()
    b = TextIOWrapperTest.BufferedWriter(r)
    with TextIOWrapperTest.assertRaisesRegex(LookupError, 'is not a text encoding'):
        TextIOWrapperTest.TextIOWrapper(b, encoding='hex')
