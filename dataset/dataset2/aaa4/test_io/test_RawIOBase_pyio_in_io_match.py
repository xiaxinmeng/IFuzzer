...
def test_RawIOBase_pyio_in_io_match():
    ...
    APIMismatchTest.assertEqual(mismatch, set(), msg='C RawIOBase does not have all Python RawIOBase methods')

APIMismatchTest = test_io.APIMismatchTest()
