...
def test_constructor_max_buffer_size_removal():
    with BufferedRWPairTest.assertRaises(TypeError):
        BufferedRWPairTest.tp(BufferedRWPairTest.MockRawIO(), BufferedRWPairTest.MockRawIO(), 8, 12)
