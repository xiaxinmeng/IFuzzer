...
def test_readonly_attributes():
    txt = CommonBufferedTests.TextIOWrapper(CommonBufferedTests.BytesIO(CommonBufferedTests.testdata), encoding='ascii')
    buf = CommonBufferedTests.BytesIO(CommonBufferedTests.testdata)
