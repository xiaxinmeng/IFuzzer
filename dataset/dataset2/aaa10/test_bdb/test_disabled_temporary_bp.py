...
def test_disabled_temporary_bp():
    code = '\n            def func():\n                lno = 3\n\n            def main():\n                for i in range(3):\n                    func()\n        '
    modules = {test_bdb.TEST_MODULE: code}
    with test_bdb.create_modules(modules):
        BreakpointTestCase.expect_set = [('line', 2, 'tfunc_import'), test_bdb.break_in_func('func', test_bdb.TEST_MODULE_FNAME), ('None', 2, 'tfunc_import'), test_bdb.break_in_func('func', test_bdb.TEST_MODULE_FNAME, True), ('None', 2, 'tfunc_import'), ('disable', (2,)), ('None', 2, 'tfunc_import'), ('continue',), ('line', 3, 'func', ({1: 1}, [])), ('enable', (2,)), ('None', 3, 'func'), ('disable', (1,)), ('None', 3, 'func'), ('continue',), ('line', 3, 'func', ({2: 1}, [2])), ('enable', (1,)), ('None', 3, 'func'), ('continue',), ('line', 3, 'func', ({1: 2}, [])), ('quit',)]
