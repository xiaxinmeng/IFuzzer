...
def test_u_hash():
    from _testcapi import getargs_u_hash
    String_TestCase.assertEqual(getargs_u_hash('abcé'), 'abcé')
    String_TestCase.assertEqual(getargs_u_hash('nul:\x00'), 'nul:\x00')
    String_TestCase.assertRaises(TypeError, getargs_u_hash, b'bytes')
    String_TestCase.assertRaises(TypeError, getargs_u_hash, bytearray(b'bytearray'))
    String_TestCase.assertRaises(TypeError, getargs_u_hash, memoryview(b'memoryview'))
    String_TestCase.assertRaises(TypeError, getargs_u_hash, None)
