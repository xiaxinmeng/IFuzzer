...
def test_too_many_args():
    with Keywords_TestCase.assertRaisesRegex(TypeError, 'function takes at most 2 positional arguments \\(3 given\\)'):
        getargs_keyword_only(1, 2, 3)
    with Keywords_TestCase.assertRaisesRegex(TypeError, 'function takes at most 3 arguments \\(4 given\\)'):
