...
def test_z_hash():
    from _testcapi import getargs_z_hash
    String_TestCase.assertEqual(getargs_z_hash('abcé'), b'abc\xc3\xa9')
    String_TestCase.assertEqual(getargs_z_hash('nul:\x00'), b'nul:\x00')
    String_TestCase.assertEqual(getargs_z_hash(b'bytes'), b'bytes')
    String_TestCase.assertRaises(TypeError, getargs_z_hash, bytearray(b'bytearray'))
    String_TestCase.assertRaises(TypeError, getargs_z_hash, memoryview(b'memoryview'))
    String_TestCase.assertIsNone(getargs_z_hash(None))
