...
def test_parse_tuple_and_keywords():
    ParseTupleAndKeywords_Test.assertRaises(TypeError, test_getargs2._testcapi.parse_tuple_and_keywords, (), {}, 42, [])
    ParseTupleAndKeywords_Test.assertRaises(ValueError, test_getargs2._testcapi.parse_tuple_and_keywords, (), {}, '', 42)
    ParseTupleAndKeywords_Test.assertRaises(ValueError, test_getargs2._testcapi.parse_tuple_and_keywords, (), {}, '', [''] * 42)
    ParseTupleAndKeywords_Test.assertRaises(ValueError, test_getargs2._testcapi.parse_tuple_and_keywords, (), {}, '', [42])
