...
def test_y_star():
    from _testcapi import getargs_y_star
    Bytes_TestCase.assertRaises(TypeError, getargs_y_star, 'abcé')
    Bytes_TestCase.assertEqual(getargs_y_star(b'bytes'), b'bytes')
    Bytes_TestCase.assertEqual(getargs_y_star(b'nul:\x00'), b'nul:\x00')
    Bytes_TestCase.assertEqual(getargs_y_star(bytearray(b'bytearray')), b'bytearray')
    Bytes_TestCase.assertEqual(getargs_y_star(memoryview(b'memoryview')), b'memoryview')
    Bytes_TestCase.assertRaises(TypeError, getargs_y_star, None)

Bytes_TestCase = test_getargs2.Bytes_TestCase()
test_y_star()
