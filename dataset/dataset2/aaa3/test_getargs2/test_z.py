...
def test_z():
    from _testcapi import getargs_z
    String_TestCase.assertEqual(getargs_z('abcé'), b'abc\xc3\xa9')
    String_TestCase.assertRaises(ValueError, getargs_z, 'nul:\x00')
    String_TestCase.assertRaises(TypeError, getargs_z, b'bytes')
    String_TestCase.assertRaises(TypeError, getargs_z, bytearray(b'bytearray'))
    String_TestCase.assertRaises(TypeError, getargs_z, memoryview(b'memoryview'))
    String_TestCase.assertIsNone(getargs_z(None))
