...
def test_s_hash():
    from _testcapi import getargs_s_hash
    String_TestCase.assertEqual(getargs_s_hash('abcé'), b'abc\xc3\xa9')
    String_TestCase.assertEqual(getargs_s_hash('nul:\x00'), b'nul:\x00')
    String_TestCase.assertEqual(getargs_s_hash(b'bytes'), b'bytes')
    String_TestCase.assertRaises(TypeError, getargs_s_hash, bytearray(b'bytearray'))
    String_TestCase.assertRaises(TypeError, getargs_s_hash, memoryview(b'memoryview'))
    String_TestCase.assertRaises(TypeError, getargs_s_hash, None)
