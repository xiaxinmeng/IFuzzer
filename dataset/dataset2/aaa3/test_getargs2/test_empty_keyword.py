...
def test_empty_keyword():
    with PositionalOnlyAndKeywords_TestCase.assertRaisesRegex(TypeError, "'' is an invalid keyword argument for this function"):
        PositionalOnlyAndKeywords_TestCase.getargs(1, 2, **{'': 666})

PositionalOnlyAndKeywords_TestCase = test_getargs2.PositionalOnlyAndKeywords_TestCase()
test_empty_keyword()
