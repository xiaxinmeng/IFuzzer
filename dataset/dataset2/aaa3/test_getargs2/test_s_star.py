...
def test_s_star():
    from _testcapi import getargs_s_star
    String_TestCase.assertEqual(getargs_s_star('abcé'), b'abc\xc3\xa9')
    String_TestCase.assertEqual(getargs_s_star('nul:\x00'), b'nul:\x00')
    String_TestCase.assertEqual(getargs_s_star(b'bytes'), b'bytes')
    String_TestCase.assertEqual(getargs_s_star(bytearray(b'bytearray')), b'bytearray')
    String_TestCase.assertEqual(getargs_s_star(memoryview(b'memoryview')), b'memoryview')
    String_TestCase.assertRaises(TypeError, getargs_s_star, None)
