...
def test_y_hash():
    from _testcapi import getargs_y_hash
    Bytes_TestCase.assertRaises(TypeError, getargs_y_hash, 'abcé')
    Bytes_TestCase.assertEqual(getargs_y_hash(b'bytes'), b'bytes')
    Bytes_TestCase.assertEqual(getargs_y_hash(b'nul:\x00'), b'nul:\x00')
    Bytes_TestCase.assertRaises(TypeError, getargs_y_hash, bytearray(b'bytearray'))
    Bytes_TestCase.assertRaises(TypeError, getargs_y_hash, memoryview(b'memoryview'))
    Bytes_TestCase.assertRaises(TypeError, getargs_y_hash, None)
