...
def test_c():
    from _testcapi import getargs_c
    Bytes_TestCase.assertRaises(TypeError, getargs_c, b'abc')
    Bytes_TestCase.assertEqual(getargs_c(b'a'), 97)
    Bytes_TestCase.assertEqual(getargs_c(bytearray(b'a')), 97)
    Bytes_TestCase.assertRaises(TypeError, getargs_c, memoryview(b'a'))
    Bytes_TestCase.assertRaises(TypeError, getargs_c, 's')
    Bytes_TestCase.assertRaises(TypeError, getargs_c, 97)
    Bytes_TestCase.assertRaises(TypeError, getargs_c, None)
