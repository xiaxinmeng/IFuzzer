...
def test_required_args():
    Keywords_TestCase.assertEqual(Keywords_TestCase.getargs(1), (1, -1, -1))
    with Keywords_TestCase.assertRaisesRegex(TypeError, 'function takes at least 1 positional argument \\(0 given\\)'):
        Keywords_TestCase.getargs()
    with Keywords_TestCase.assertRaisesRegex(TypeError, 'function takes at least 1 positional argument \\(0 given\\)'):
        Keywords_TestCase.getargs(keyword=3)
