...
def test_positional_only():
    parse = test_getargs2._testcapi.parse_tuple_and_keywords
    parse((1, 2, 3), {}, 'OOO', ['', '', 'a'])
    parse((1, 2), {'a': 3}, 'OOO', ['', '', 'a'])
    with ParseTupleAndKeywords_Test.assertRaisesRegex(TypeError, 'function takes at least 2 positional arguments \\(1 given\\)'):
        parse((1,), {'a': 3}, 'OOO', ['', '', 'a'])
    parse((1,), {}, 'O|OO', ['', '', 'a'])
    with ParseTupleAndKeywords_Test.assertRaisesRegex(TypeError, 'function takes at least 1 positional argument \\(0 given\\)'):
        parse((), {}, 'O|OO', ['', '', 'a'])
    parse((1, 2), {'a': 3}, 'OO$O', ['', '', 'a'])
    with ParseTupleAndKeywords_Test.assertRaisesRegex(TypeError, 'function takes exactly 2 positional arguments \\(1 given\\)'):
        parse((1,), {'a': 3}, 'OO$O', ['', '', 'a'])
    parse((1,), {}, 'O|O$O', ['', '', 'a'])
    with ParseTupleAndKeywords_Test.assertRaisesRegex(TypeError, 'function takes at least 1 positional argument \\(0 given\\)'):
        parse((), {}, 'O|O$O', ['', '', 'a'])
    with ParseTupleAndKeywords_Test.assertRaisesRegex(SystemError, 'Empty parameter name after \\$'):
        parse((1,), {}, 'O|$OO', ['', '', 'a'])
    with ParseTupleAndKeywords_Test.assertRaisesRegex(SystemError, 'Empty keyword'):
        parse((1,), {}, 'O|OO', ['', 'a', ''])
