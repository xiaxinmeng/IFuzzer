...
def test_untested_modules_can_be_imported():
    untested = ('encodings',)
    with warnings_helper.check_warnings(quiet=True):
        for name in untested:
            try:
                ...
                TestUntestedModules.fail('{} has tests even though test_sundry claims otherwise'.format(name))
...
TestUntestedModules = test_sundry.TestUntestedModules()
