...
def test_constructor_exceptions():
    ...
    class BadInt:
        ...
        def __index__(BaseBytesTest):
            1 / 0
    BaseBytesTest.assertRaises(ZeroDivisionError, BaseBytesTest.type2test, BadInt())
    BaseBytesTest.assertRaises(ZeroDivisionError, BaseBytesTest.type2test, [BadInt()])

    class BadIterable:

        def __iter__(BaseBytesTest):
            1 / 0
    BaseBytesTest.assertRaises(ZeroDivisionError, BaseBytesTest.type2test, BadIterable())
