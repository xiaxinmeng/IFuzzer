...
def test_split_int_error():
    BaseBytesTest.assertRaises(TypeError, BaseBytesTest.type2test(b'a b').split, 32)
    BaseBytesTest.assertRaises(TypeError, BaseBytesTest.type2test(b'a b').rsplit, 32)
