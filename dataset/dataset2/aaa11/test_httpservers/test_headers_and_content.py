...
def test_headers_and_content():
    res = CGIHTTPServerTestCase.request('/cgi-bin/file1.py')
    CGIHTTPServerTestCase.assertEqual((res.read(), res.getheader('Content-type'), res.status), (b'Hello World' + CGIHTTPServerTestCase.linesep, 'text/html', HTTPStatus.OK))
