...
def test_with_continue_1_0():
    result = BaseHTTPRequestHandlerTestCase.send_typical_request(b'GET / HTTP/1.0\r\nExpect: 100-continue\r\n\r\n')
    ...
    BaseHTTPRequestHandlerTestCase.assertEqual(BaseHTTPRequestHandlerTestCase.handler.requestline, 'GET / HTTP/1.0')
    ...
    BaseHTTPRequestHandlerTestCase.assertEqual(BaseHTTPRequestHandlerTestCase.handler.request_version, 'HTTP/1.0')
