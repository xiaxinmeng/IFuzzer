...
def test_connect_with_tunnel():
    ...
    TunnelTests.assertNotIn(b'Host: destination.com:None', TunnelTests.conn.sock.data)
    TunnelTests.assertIn(b'Host: destination.com', TunnelTests.conn.sock.data)
    TunnelTests.assertNotIn(b'Host: proxy.com', TunnelTests.conn.sock.data)
