...
def test_constructor_defaults():
    ...
    UnicodeTest.assertEqual(str(), '')
    UnicodeTest.assertEqual(str(errors='strict'), '')
    utf8_cent = '¢'.encode('utf-8')
    UnicodeTest.assertEqual(str(utf8_cent, errors='strict'), '¢')
    UnicodeTest.assertRaises(UnicodeDecodeError, str, utf8_cent, encoding='ascii')
