...
def test_isalpha():
    super().test_isalpha()
    UnicodeTest.checkequalnofix(True, 'ῼ', 'isalpha')
    UnicodeTest.assertTrue('𐐁'.isalpha())
    UnicodeTest.assertTrue('𐐧'.isalpha())
    UnicodeTest.assertTrue('𐐩'.isalpha())
    UnicodeTest.assertTrue('𐑎'.isalpha())
    UnicodeTest.assertFalse('🐍'.isalpha())
    UnicodeTest.assertFalse('👯'.isalpha())
