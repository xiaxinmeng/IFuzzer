...
def test_bytes_comparison():
    with warnings_helper.check_warnings():
        ...
        UnicodeTest.assertEqual('abc' == b'abc', False)
        UnicodeTest.assertEqual('abc' != b'abc', True)
        UnicodeTest.assertEqual('abc' == bytearray(b'abc'), False)
        UnicodeTest.assertEqual('abc' != bytearray(b'abc'), True)
