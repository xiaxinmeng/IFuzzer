...
def test_async_iterator():
    base_it = range(10)
    it = test_typing.AsyncIteratorWrapper(base_it)
    CollectionsAbcTests.assertIsInstance(it, typing.AsyncIterator)
    CollectionsAbcTests.assertNotIsInstance(42, typing.AsyncIterator)
