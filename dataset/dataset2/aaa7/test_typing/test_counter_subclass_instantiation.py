...
def test_counter_subclass_instantiation():
    ...
    class MyCounter(typing.Counter[int]):
        pass
    d = MyCounter()
    CollectionsAbcTests.assertIsInstance(d, MyCounter)
    CollectionsAbcTests.assertIsInstance(d, typing.Counter)
    CollectionsAbcTests.assertIsInstance(d, collections.Counter)
