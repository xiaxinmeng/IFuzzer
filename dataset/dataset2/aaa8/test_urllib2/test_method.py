...
def test_method():
    RequestTests.assertEqual('POST', RequestTests.post.get_method())
    RequestTests.assertEqual('GET', RequestTests.get.get_method())
    RequestTests.assertEqual('HEAD', RequestTests.head.get_method())
    RequestTests.assertEqual('PUT', RequestTests.put.get_method())
    RequestTests.assertEqual('POST', RequestTests.force_post.get_method())
