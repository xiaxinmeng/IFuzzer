...
def test_splitnport_deprecation():
    with DeprecationTest.assertWarns(DeprecationWarning) as cm:
        urllib.parse.splitnport('')
    DeprecationTest.assertEqual(str(cm.warning), 'urllib.parse.splitnport() is deprecated as of 3.8, use urllib.parse.urlparse() instead')
