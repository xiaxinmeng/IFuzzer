...
def test_splittag_deprecation():
    with DeprecationTest.assertWarns(DeprecationWarning) as cm:
        urllib.parse.splittag('')
    DeprecationTest.assertEqual(str(cm.warning), 'urllib.parse.splittag() is deprecated as of 3.8, use urllib.parse.urlparse() instead')
