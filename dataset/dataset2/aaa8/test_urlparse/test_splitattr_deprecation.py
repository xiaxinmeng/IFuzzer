...
def test_splitattr_deprecation():
    with DeprecationTest.assertWarns(DeprecationWarning) as cm:
        urllib.parse.splitattr('')
    DeprecationTest.assertEqual(str(cm.warning), 'urllib.parse.splitattr() is deprecated as of 3.8, use urllib.parse.urlparse() instead')
