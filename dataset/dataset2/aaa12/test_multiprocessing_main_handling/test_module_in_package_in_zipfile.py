...
def test_module_in_package_in_zipfile():
    with os_helper.temp_dir() as script_dir:
        (zip_name, run_name) = test_multiprocessing_main_handling._make_test_zip_pkg(script_dir, 'test_zip', 'test_pkg', 'script')
        launch_name = test_multiprocessing_main_handling._make_launch_script(script_dir, 'launch', 'test_pkg.script', zip_name)
